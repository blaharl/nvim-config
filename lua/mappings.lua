...
vim.keymap.set('v', '<leader>d', '"_d', { desc = 'delete with reg preserved' })
vim.keymap.set('v', '<leader>p', '"_dP', { desc = 'paste with reg preserved' })
...
vim.keymap.set(
  { 'n', 't' },
  '<A-v>',
  function() require('toggleterm').toggle(1, vim.o.columns * 0.4, '', 'vertical') end,
  { desc = 'terminal toggleable vertical term' }
)
--
vim.keymap.set({ 'n', 't' }, '<A-h>', function() require('toggleterm').toggle(1, 15, '', 'horizontal') end, { desc = 'terminal toggleable horizontal term' })
